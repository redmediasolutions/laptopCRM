import '/accounting/invoices_components/generate_barcode/generate_barcode_widget.dart';
import '/accounting/invoices_components/print_invoice/print_invoice_widget.dart';
import '/accounting/invoices_components/record_payment/record_payment_widget.dart';
                                    ...
                                    Expanded(
                                      ...
                                      child:
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<AllInvoicesRow>
                                              showInvoiceAllInvoicesRowList =
                                              snapshot.data!;

                                          final showInvoiceAllInvoicesRow =
                                              showInvoiceAllInvoicesRowList
                                                      .isNotEmpty
                                                  ? showInvoiceAllInvoicesRowList
                                                      .first
                                                                                    ...
                                                                                    Expanded(
                                                                                      ...
                                                                                      child: Column(
                                                                                        ...
                                                                                        children: [
                                                                                          Text(
                                                                                            valueOrDefault<String>(
                                                                                              paymentsItem.paymentAmount?.toString(),
                                                                                              '0',
                                                                                            ),
                                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                  font: GoogleFonts.inter(
                                                                                          ...
                                                                                          if (confirmDialogResponse) {
                                                                                            ...
                                                                                            await showDialog(
                                                                                              ...
                                                                                              builder: (alertDialogContext) {
                                                                                                return AlertDialog(
                                                                                                  title: Text('Deleted'),
                                                                                                  content: Text('Payment record has been deleted'),
                                                                                                  actions: [
                                                                                                    TextButton(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            formatNumber(
                                                                              functions.calculateTotal(containerPaymentsRowList.toList()),
