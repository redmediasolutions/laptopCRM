...
import '/products/stock/stock_components/barcode/barcode_widget.dart';
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Container(
                    width: 88.0,
                    height: MediaQuery.sizeOf(context).height * 0.961,
                    child: wrapWithModel(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              valueOrDefault<String>(
                                                                                listViewAllstockv2Row.productSerial,
                                                                                'NA',
                                                                              ),
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    font: GoogleFonts.inter(
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            formatNumber(
                                                                              functions.stringtoDouble(listViewAllstockv2Row.saleprice!),
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            builder:
                                                                                (context) {
                                                                              if (listViewAllstockv2Row.isSold == true) {
                                                                                return Align(
