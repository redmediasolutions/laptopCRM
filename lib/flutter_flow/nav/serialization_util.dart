    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case Allstockv2Row:
            return Allstockv2Row(data);
          case CustomersRow:
            return CustomersRow(data);
          case AllProductsRow:
            return AllProductsRow(data);
          case MasterlistproductsRow:
            return MasterlistproductsRow(data);
          case StockRow:
            return StockRow(data);
          case AllVendorpaymentsRow:
            return AllVendorpaymentsRow(data);
          case ProductsRow:
