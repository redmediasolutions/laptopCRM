...
import '/products/create_product/create_product_widget.dart';
import '/products/update_product/update_product_widget.dart';
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 4.0, 0.0, 0.0),
                                        child: Text(
                                          'Create a list of products managed by you',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                ...
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 16.0, 0.0),
                                    child: FutureBuilder<
                                        List<MasterlistproductsRow>>(
                                      future:
                                          MasterlistproductsTable().queryRows(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<MasterlistproductsRow>
                                            cardTable6MasterlistproductsRowList =
                                            snapshot.data!;
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'Products (${cardTable6MasterlistproductsRowList.length.toString()})',
                                                                                ...
                                                                                return GestureDetector(
                                                                                  ...
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: UpdateProductWidget(
                                                                                      typeref: productListItem.typereference!,
                                                                                      brandRef: productListItem.brandreference!,
                                                                                      productid: productListItem.productid,
                                                                                      nameofProduct: productListItem.productName,
                                                                                      config: productListItem.productConfig,
                                                                                      description: productListItem.productDescription,
                                                                                      productCode: productListItem.productcode,
                                                                                    ),
                                                                                  ),
                                                                                );
                                                                              },
                                                                              ...
                                                                              builder: (context) {
                                                                                return GestureDetector(
                                                                                  ...
                                                                                  child: Padding(
                                                                                    padding: MediaQuery.viewInsetsOf(context),
                                                                                    child: UpdateProductWidget(
                                                                                      typeref: productSearchItem.typeRef,
                                                                                      brandRef: productSearchItem.brandref,
                                                                                      productid: productSearchItem.productid,
                                                                                      nameofProduct: productSearchItem.name,
                                                                                      config: productSearchItem.configuration,
                                                                                      description: productSearchItem.productDescription,
                                                                                      productCode: productSearchItem.productCode,
                                                                                    ),
                                                                                  ),
                                                                                );
                                                                              },
