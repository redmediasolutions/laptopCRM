...
import 'stock_list_component_copy_model.dart';
export 'stock_list_component_copy_model.dart';

class StockListComponentCopyWidget extends StatefulWidget {
  const StockListComponentCopyWidget({
    super.key,
    this.parameter1,
    this.parameter2,
    this.parameter3,
  ...
  @override
  State<StockListComponentCopyWidget> createState() =>
      _StockListComponentCopyWidgetState();
}

class _StockListComponentCopyWidgetState
    extends State<StockListComponentCopyWidget> {
  late StockListComponentCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StockListComponentCopyModel());
